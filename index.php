...
<html lang="es">
  <head>
    ...
    <title>Cargar Google Maps en Vue JS 2 </title>
  ...
  <body> 
        ...
        <div class="container text-center mt-5">
          ...
          <div class="row">
            ...
            <div class="col-md-12" align="center">
                ...
                <h1>Cargar Google Maps en Vue JS 2 </h1>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhYUfjEeshV3YvREsoyFEuZk-sDeY29qM"></script>
    ...
    <script type="text/javascript">
      ...
      data () {
        return {
          lat: 'Welcome to Your Vue.js App'
          lng:
        }
      },
